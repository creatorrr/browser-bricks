...
(function() {
  var $, $$, BALL_VELOCITY, BL, BR, BROWSER, Ball, Box, Brick, Bricks, DRAW_INTERVAL, Events, Game, Grid, PADDLE_VELOCITY, Paddle, ROOT, Screen, StateMachine, TL, TR, X, Y, init, _, _ref, _ref1,
  ...
  if (!window.Set) {
    window.Set = (function(_super) {
      ...
      Set.prototype["delete"] = function(e) {
        var found;
        found = this.indexOf(e);
        if (found !== -1) {
          return this.splice(found, 1);
        }
      };
  ...
  Box = (function(_super) {
    ...
    Box.prototype._getAll = function() {
      return _.extend(_.clone(this._settings), this._props);
    };
  ...
  Grid = (function(_super) {
    ...
    Grid.prototype.popupsDisplayed = function() {
      var popups;
      popups = this.elements.bricks.map(function(i) {
        return i._window;
      });
      return popups.reduce((function(result, popup) {
        return result && (popup != null);
      }), true);
    };
        ...
        if ((_this._grid != null) && !_this._grid.popupsDisplayed()) {
          ...
          if (window.confirm("Please enable popups before playing this game. Do you wish to be taken to your browser's corresponding support page?")) {
            ...
            url = (function() {
              switch (BROWSER) {
                case 'chrome':
                  return 'https://support.google.com/chrome/answer/95472?hl=en';
                case 'firefox':
                  return 'https://support.mozilla.org/en-US/kb/pop-blocker-settings-exceptions-troubleshooting#w_pop-up-blocker-settings';
                default:
  ...
  $ = function(q) {
    return window.document.querySelector(q);
  };

  $$ = function(q) {
    return window.document.querySelectorAll(q);
  };
