...
(function() {
  var BALL_VELOCITY, BL, BR, Ball, Box, Brick, Bricks, DRAW_INTERVAL, Events, Game, Grid, HOST_NAME, PADDLE_VELOCITY, Paddle, Screen, StateMachine, TL, TR, X, Y, init, _, _ref, _ref1,
    __slice = [].slice,
    ...
    function Grid() {
      ...
      this.elements = {
        bricks: new Bricks(this, {
          ...
          columns: 10,
          template: function() {
            return "<body style=\"background: url('" + HOST_NAME + "/img/bricks.png');\"></body>";
          }
        }),
        paddle: new Paddle({
          ...
          template: function() {
            return "<body style=\"background: url('" + HOST_NAME + "/img/pattern.png');\"></body>";
          }
        }),
        ball: new Ball({
